...
class IndicatorsTrophySpin(Component):
    """An IndicatorsTrophySpin component.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsTrophySpin, self).__init__(**args)

setattr(IndicatorsTrophySpin, "__init__", _explicitize_args(IndicatorsTrophySpin.__init__))
