...
class LoadingDevEclipse(Component):
    """A LoadingDevEclipse component.
LoadingDevEclipse — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevEclipse, self).__init__(**args)

setattr(LoadingDevEclipse, "__init__", _explicitize_args(LoadingDevEclipse.__init__))
