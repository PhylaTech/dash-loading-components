...
class PremiumPulseDots(Component):
    """A PremiumPulseDots component.
...
- speed (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PremiumPulseDots, self).__init__(**args)

setattr(PremiumPulseDots, "__init__", _explicitize_args(PremiumPulseDots.__init__))
