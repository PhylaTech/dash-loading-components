...
class SpinnersReactSpinnerCircular(Component):
    """A SpinnersReactSpinnerCircular component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerCircular'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerCircular, self).__init__(**args)

setattr(SpinnersReactSpinnerCircular, "__init__", _explicitize_args(SpinnersReactSpinnerCircular.__init__))
