...
class LdrsDotWave(Component):
    """A LdrsDotWave component.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LdrsDotWave, self).__init__(**args)

setattr(LdrsDotWave, "__init__", _explicitize_args(LdrsDotWave.__init__))
