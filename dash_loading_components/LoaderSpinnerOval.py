...
class LoaderSpinnerOval(Component):
    """A LoaderSpinnerOval component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerOval, self).__init__(**args)

setattr(LoaderSpinnerOval, "__init__", _explicitize_args(LoaderSpinnerOval.__init__))
