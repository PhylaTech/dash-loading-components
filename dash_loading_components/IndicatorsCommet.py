...
class IndicatorsCommet(Component):
    """An IndicatorsCommet component.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsCommet, self).__init__(**args)

setattr(IndicatorsCommet, "__init__", _explicitize_args(IndicatorsCommet.__init__))
