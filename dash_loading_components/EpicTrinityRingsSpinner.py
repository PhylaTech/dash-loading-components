...
class EpicTrinityRingsSpinner(Component):
    """An EpicTrinityRingsSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicTrinityRingsSpinner, self).__init__(**args)

setattr(EpicTrinityRingsSpinner, "__init__", _explicitize_args(EpicTrinityRingsSpinner.__init__))
