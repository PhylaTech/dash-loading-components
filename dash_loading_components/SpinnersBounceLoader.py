...
class SpinnersBounceLoader(Component):
    """A SpinnersBounceLoader component.
SpinnersBounceLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersBounceLoader, self).__init__(**args)

setattr(SpinnersBounceLoader, "__init__", _explicitize_args(SpinnersBounceLoader.__init__))
