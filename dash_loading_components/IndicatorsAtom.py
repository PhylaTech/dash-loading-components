...
class IndicatorsAtom(Component):
    """An IndicatorsAtom component.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsAtom, self).__init__(**args)

setattr(IndicatorsAtom, "__init__", _explicitize_args(IndicatorsAtom.__init__))
