...
class SpinnersReactSpinnerRoundOutlined(Component):
    """A SpinnersReactSpinnerRoundOutlined component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerRoundOutlined'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerRoundOutlined, self).__init__(**args)

setattr(SpinnersReactSpinnerRoundOutlined, "__init__", _explicitize_args(SpinnersReactSpinnerRoundOutlined.__init__))
