...
class LoadingDevRipple(Component):
    """A LoadingDevRipple component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'direction', 'duration', 'play_state', 'playing', 'rate', 'size', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'direction', 'duration', 'play_state', 'playing', 'rate', 'size', 'style']
        ...
        super(LoadingDevRipple, self).__init__(**args)

setattr(LoadingDevRipple, "__init__", _explicitize_args(LoadingDevRipple.__init__))
