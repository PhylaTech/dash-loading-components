...
class LoadingDevTrace(Component):
    """A LoadingDevTrace component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevTrace, self).__init__(**args)

setattr(LoadingDevTrace, "__init__", _explicitize_args(LoadingDevTrace.__init__))
