...
class IndicatorsBlinkBlur(Component):
    """An IndicatorsBlinkBlur component.
IndicatorsBlinkBlur — Dash wrapper for upstream spinner.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsBlinkBlur, self).__init__(**args)

setattr(IndicatorsBlinkBlur, "__init__", _explicitize_args(IndicatorsBlinkBlur.__init__))
