...
class LoadingDevAtom(Component):
    """A LoadingDevAtom component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevAtom, self).__init__(**args)

setattr(LoadingDevAtom, "__init__", _explicitize_args(LoadingDevAtom.__init__))
