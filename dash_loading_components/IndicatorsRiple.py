...
class IndicatorsRiple(Component):
    """An IndicatorsRiple component.
IndicatorsRiple — Dash wrapper for upstream spinner.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsRiple, self).__init__(**args)

setattr(IndicatorsRiple, "__init__", _explicitize_args(IndicatorsRiple.__init__))
