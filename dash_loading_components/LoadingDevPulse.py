...
class LoadingDevPulse(Component):
    """A LoadingDevPulse component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevPulse, self).__init__(**args)

setattr(LoadingDevPulse, "__init__", _explicitize_args(LoadingDevPulse.__init__))
