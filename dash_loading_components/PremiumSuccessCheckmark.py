...
class PremiumSuccessCheckmark(Component):
    """A PremiumSuccessCheckmark component.
...
- visible (boolean; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'playing', 'rate', 'secondary_color', 'size', 'speed', 'style', 'visible']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'playing', 'rate', 'secondary_color', 'size', 'speed', 'style', 'visible']
        ...
        super(PremiumSuccessCheckmark, self).__init__(**args)

setattr(PremiumSuccessCheckmark, "__init__", _explicitize_args(PremiumSuccessCheckmark.__init__))
