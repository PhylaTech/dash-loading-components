...
class EpicFlowerSpinner(Component):
    """An EpicFlowerSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicFlowerSpinner, self).__init__(**args)

setattr(EpicFlowerSpinner, "__init__", _explicitize_args(EpicFlowerSpinner.__init__))
