...
class LoadingDevLoading(Component):
    """A LoadingDevLoading component.
LoadingDevLoading — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevLoading, self).__init__(**args)

setattr(LoadingDevLoading, "__init__", _explicitize_args(LoadingDevLoading.__init__))
