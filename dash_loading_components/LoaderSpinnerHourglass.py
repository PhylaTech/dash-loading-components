...
class LoaderSpinnerHourglass(Component):
    """A LoaderSpinnerHourglass component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerHourglass, self).__init__(**args)

setattr(LoaderSpinnerHourglass, "__init__", _explicitize_args(LoaderSpinnerHourglass.__init__))
