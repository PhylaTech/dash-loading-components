...
class LoadingDevArc(Component):
    """A LoadingDevArc component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevArc, self).__init__(**args)

setattr(LoadingDevArc, "__init__", _explicitize_args(LoadingDevArc.__init__))
