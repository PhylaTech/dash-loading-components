...
class SpinnersBeatLoader(Component):
    """A SpinnersBeatLoader component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersBeatLoader, self).__init__(**args)

setattr(SpinnersBeatLoader, "__init__", _explicitize_args(SpinnersBeatLoader.__init__))
