...
class LoaderSpinnerDNA(Component):
    """A LoaderSpinnerDNA component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerDNA, self).__init__(**args)

setattr(LoaderSpinnerDNA, "__init__", _explicitize_args(LoaderSpinnerDNA.__init__))
