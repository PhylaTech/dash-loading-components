...
class PremiumInfinityLoader(Component):
    """A PremiumInfinityLoader component.
...
- speed (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PremiumInfinityLoader, self).__init__(**args)

setattr(PremiumInfinityLoader, "__init__", _explicitize_args(PremiumInfinityLoader.__init__))
