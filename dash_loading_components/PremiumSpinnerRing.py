...
class PremiumSpinnerRing(Component):
    """A PremiumSpinnerRing component.
...
- visible (boolean; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'playing', 'rate', 'reverse', 'secondary_color', 'size', 'speed', 'style', 'thickness', 'visible']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'playing', 'rate', 'reverse', 'secondary_color', 'size', 'speed', 'style', 'thickness', 'visible']
        ...
        super(PremiumSpinnerRing, self).__init__(**args)

setattr(PremiumSpinnerRing, "__init__", _explicitize_args(PremiumSpinnerRing.__init__))
