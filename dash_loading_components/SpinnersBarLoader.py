...
class SpinnersBarLoader(Component):
    """A SpinnersBarLoader component.
SpinnersBarLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersBarLoader, self).__init__(**args)

setattr(SpinnersBarLoader, "__init__", _explicitize_args(SpinnersBarLoader.__init__))
