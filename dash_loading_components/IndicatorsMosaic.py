...
class IndicatorsMosaic(Component):
    """An IndicatorsMosaic component.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsMosaic, self).__init__(**args)

setattr(IndicatorsMosaic, "__init__", _explicitize_args(IndicatorsMosaic.__init__))
