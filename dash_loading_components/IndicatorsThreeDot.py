...
class IndicatorsThreeDot(Component):
    """An IndicatorsThreeDot component.
IndicatorsThreeDot — Dash wrapper for upstream spinner.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(IndicatorsThreeDot, self).__init__(**args)

setattr(IndicatorsThreeDot, "__init__", _explicitize_args(IndicatorsThreeDot.__init__))
