...
class SpinnersReactSpinnerDiamond(Component):
    """A SpinnersReactSpinnerDiamond component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerDiamond'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerDiamond, self).__init__(**args)

setattr(SpinnersReactSpinnerDiamond, "__init__", _explicitize_args(SpinnersReactSpinnerDiamond.__init__))
