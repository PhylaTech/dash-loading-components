...
class LdrsLineSpinner(Component):
    """A LdrsLineSpinner component.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LdrsLineSpinner, self).__init__(**args)

setattr(LdrsLineSpinner, "__init__", _explicitize_args(LdrsLineSpinner.__init__))
