...
class EpicAtomSpinner(Component):
    """An EpicAtomSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicAtomSpinner, self).__init__(**args)

setattr(EpicAtomSpinner, "__init__", _explicitize_args(EpicAtomSpinner.__init__))
