...
class SpinnersGridLoader(Component):
    """A SpinnersGridLoader component.
SpinnersGridLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersGridLoader, self).__init__(**args)

setattr(SpinnersGridLoader, "__init__", _explicitize_args(SpinnersGridLoader.__init__))
