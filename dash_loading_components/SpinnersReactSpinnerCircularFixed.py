...
class SpinnersReactSpinnerCircularFixed(Component):
    """A SpinnersReactSpinnerCircularFixed component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerCircularFixed'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerCircularFixed, self).__init__(**args)

setattr(SpinnersReactSpinnerCircularFixed, "__init__", _explicitize_args(SpinnersReactSpinnerCircularFixed.__init__))
