...
class LdrsInfinity(Component):
    """A LdrsInfinity component.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LdrsInfinity, self).__init__(**args)

setattr(LdrsInfinity, "__init__", _explicitize_args(LdrsInfinity.__init__))
