...
class LoadingDevLinearDots(Component):
    """A LoadingDevLinearDots component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevLinearDots, self).__init__(**args)

setattr(LoadingDevLinearDots, "__init__", _explicitize_args(LoadingDevLinearDots.__init__))
