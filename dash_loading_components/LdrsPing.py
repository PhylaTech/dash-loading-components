...
class LdrsPing(Component):
    """A LdrsPing component.
LdrsPing — Dash wrapper for upstream spinner.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LdrsPing, self).__init__(**args)

setattr(LdrsPing, "__init__", _explicitize_args(LdrsPing.__init__))
