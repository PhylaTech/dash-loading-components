...
class SpinnersReactSpinnerRoundFilled(Component):
    """A SpinnersReactSpinnerRoundFilled component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerRoundFilled'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerRoundFilled, self).__init__(**args)

setattr(SpinnersReactSpinnerRoundFilled, "__init__", _explicitize_args(SpinnersReactSpinnerRoundFilled.__init__))
