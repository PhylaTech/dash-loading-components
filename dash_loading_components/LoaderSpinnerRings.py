...
class LoaderSpinnerRings(Component):
    """A LoaderSpinnerRings component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerRings, self).__init__(**args)

setattr(LoaderSpinnerRings, "__init__", _explicitize_args(LoaderSpinnerRings.__init__))
