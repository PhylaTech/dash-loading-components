...
class EpicOrbitSpinner(Component):
    """An EpicOrbitSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicOrbitSpinner, self).__init__(**args)

setattr(EpicOrbitSpinner, "__init__", _explicitize_args(EpicOrbitSpinner.__init__))
