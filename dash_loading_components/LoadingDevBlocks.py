...
class LoadingDevBlocks(Component):
    """A LoadingDevBlocks component.
...
- sweep (a value equal to: "columns", "diagonal", "rows"; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'duration', 'play_state', 'playing', 'rate', 'size', 'style', 'sweep']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'duration', 'play_state', 'playing', 'rate', 'size', 'style', 'sweep']
        ...
        super(LoadingDevBlocks, self).__init__(**args)

setattr(LoadingDevBlocks, "__init__", _explicitize_args(LoadingDevBlocks.__init__))
