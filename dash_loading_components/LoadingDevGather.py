...
class LoadingDevGather(Component):
    """A LoadingDevGather component.
LoadingDevGather — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevGather, self).__init__(**args)

setattr(LoadingDevGather, "__init__", _explicitize_args(LoadingDevGather.__init__))
