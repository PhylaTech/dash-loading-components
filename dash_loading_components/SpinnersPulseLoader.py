...
class SpinnersPulseLoader(Component):
    """A SpinnersPulseLoader component.
SpinnersPulseLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersPulseLoader, self).__init__(**args)

setattr(SpinnersPulseLoader, "__init__", _explicitize_args(SpinnersPulseLoader.__init__))
