...
class PremiumBouncingDots(Component):
    """A PremiumBouncingDots component.
...
- visible (boolean; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PremiumBouncingDots, self).__init__(**args)

setattr(PremiumBouncingDots, "__init__", _explicitize_args(PremiumBouncingDots.__init__))
