...
class LoadingDevDual(Component):
    """A LoadingDevDual component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevDual, self).__init__(**args)

setattr(LoadingDevDual, "__init__", _explicitize_args(LoadingDevDual.__init__))
