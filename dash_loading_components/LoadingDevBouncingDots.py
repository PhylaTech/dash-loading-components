...
class LoadingDevBouncingDots(Component):
    """A LoadingDevBouncingDots component.
LoadingDevBouncingDots — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'duration', 'play_state', 'playing', 'rate', 'size', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'duration', 'play_state', 'playing', 'rate', 'size', 'style']
        ...
        super(LoadingDevBouncingDots, self).__init__(**args)

setattr(LoadingDevBouncingDots, "__init__", _explicitize_args(LoadingDevBouncingDots.__init__))
