...
class SpinnersMoonLoader(Component):
    """A SpinnersMoonLoader component.
SpinnersMoonLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersMoonLoader, self).__init__(**args)

setattr(SpinnersMoonLoader, "__init__", _explicitize_args(SpinnersMoonLoader.__init__))
