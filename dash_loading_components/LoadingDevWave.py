...
class LoadingDevWave(Component):
    """A LoadingDevWave component.
...
- origin (a value equal to: "bottom", "center"; optional):
...
- size (number; optional):
    ...
    def __init__(
        ...
        origin: typing.Optional[Literal["bottom", "center"]] = None,
        rate: typing.Optional[NumberType] = None,
        playing: typing.Optional[bool] = None,
        **kwargs
    ):
        self._prop_names = ['id', 'className', 'color', 'duration', 'origin', 'play_state', 'playing', 'rate', 'size', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'duration', 'origin', 'play_state', 'playing', 'rate', 'size', 'style']
        ...
        super(LoadingDevWave, self).__init__(**args)

setattr(LoadingDevWave, "__init__", _explicitize_args(LoadingDevWave.__init__))
