...
class LoaderSpinnerBallTriangle(Component):
    """A LoaderSpinnerBallTriangle component.
...
- width (number | string; optional):
    ...
    _type = 'LoaderSpinnerBallTriangle'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerBallTriangle, self).__init__(**args)

setattr(LoaderSpinnerBallTriangle, "__init__", _explicitize_args(LoaderSpinnerBallTriangle.__init__))
