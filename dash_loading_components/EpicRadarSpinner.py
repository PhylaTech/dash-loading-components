...
class EpicRadarSpinner(Component):
    """An EpicRadarSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicRadarSpinner, self).__init__(**args)

setattr(EpicRadarSpinner, "__init__", _explicitize_args(EpicRadarSpinner.__init__))
