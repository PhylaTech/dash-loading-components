...
class LoaderSpinnerThreeDots(Component):
    """A LoaderSpinnerThreeDots component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerThreeDots, self).__init__(**args)

setattr(LoaderSpinnerThreeDots, "__init__", _explicitize_args(LoaderSpinnerThreeDots.__init__))
