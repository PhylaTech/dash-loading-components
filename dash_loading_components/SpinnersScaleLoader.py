...
class SpinnersScaleLoader(Component):
    """A SpinnersScaleLoader component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersScaleLoader, self).__init__(**args)

setattr(SpinnersScaleLoader, "__init__", _explicitize_args(SpinnersScaleLoader.__init__))
