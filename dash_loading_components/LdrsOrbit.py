...
class LdrsOrbit(Component):
    """A LdrsOrbit component.
LdrsOrbit — Dash wrapper for upstream spinner.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LdrsOrbit, self).__init__(**args)

setattr(LdrsOrbit, "__init__", _explicitize_args(LdrsOrbit.__init__))
