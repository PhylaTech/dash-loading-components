...
class LoaderSpinnerTailSpin(Component):
    """A LoaderSpinnerTailSpin component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerTailSpin, self).__init__(**args)

setattr(LoaderSpinnerTailSpin, "__init__", _explicitize_args(LoaderSpinnerTailSpin.__init__))
