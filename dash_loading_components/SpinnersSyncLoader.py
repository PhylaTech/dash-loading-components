...
class SpinnersSyncLoader(Component):
    """A SpinnersSyncLoader component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersSyncLoader, self).__init__(**args)

setattr(SpinnersSyncLoader, "__init__", _explicitize_args(SpinnersSyncLoader.__init__))
