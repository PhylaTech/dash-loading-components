...
class LoadingDevComet(Component):
    """A LoadingDevComet component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevComet, self).__init__(**args)

setattr(LoadingDevComet, "__init__", _explicitize_args(LoadingDevComet.__init__))
