...
class LoadingDevRadar(Component):
    """A LoadingDevRadar component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevRadar, self).__init__(**args)

setattr(LoadingDevRadar, "__init__", _explicitize_args(LoadingDevRadar.__init__))
