...
class LoadingDevClassic(Component):
    """A LoadingDevClassic component.
LoadingDevClassic — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevClassic, self).__init__(**args)

setattr(LoadingDevClassic, "__init__", _explicitize_args(LoadingDevClassic.__init__))
