...
class SpinnersReactSpinnerDotted(Component):
    """A SpinnersReactSpinnerDotted component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerDotted'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerDotted, self).__init__(**args)

setattr(SpinnersReactSpinnerDotted, "__init__", _explicitize_args(SpinnersReactSpinnerDotted.__init__))
