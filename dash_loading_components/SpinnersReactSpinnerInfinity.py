...
class SpinnersReactSpinnerInfinity(Component):
    """A SpinnersReactSpinnerInfinity component.
...
- thickness (number; optional):
    ...
    _type = 'SpinnersReactSpinnerInfinity'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersReactSpinnerInfinity, self).__init__(**args)

setattr(SpinnersReactSpinnerInfinity, "__init__", _explicitize_args(SpinnersReactSpinnerInfinity.__init__))
