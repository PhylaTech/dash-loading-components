...
class SpinnersRingLoader(Component):
    """A SpinnersRingLoader component.
SpinnersRingLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersRingLoader, self).__init__(**args)

setattr(SpinnersRingLoader, "__init__", _explicitize_args(SpinnersRingLoader.__init__))
