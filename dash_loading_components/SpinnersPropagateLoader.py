...
class SpinnersPropagateLoader(Component):
    """A SpinnersPropagateLoader component.
SpinnersPropagateLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'height', 'loading', 'margin', 'playing', 'rate', 'size', 'speed_multiplier', 'style', 'width']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'height', 'loading', 'margin', 'playing', 'rate', 'size', 'speed_multiplier', 'style', 'width']
        ...
        super(SpinnersPropagateLoader, self).__init__(**args)

setattr(SpinnersPropagateLoader, "__init__", _explicitize_args(SpinnersPropagateLoader.__init__))
