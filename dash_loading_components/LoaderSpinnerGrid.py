...
class LoaderSpinnerGrid(Component):
    """A LoaderSpinnerGrid component.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerGrid, self).__init__(**args)

setattr(LoaderSpinnerGrid, "__init__", _explicitize_args(LoaderSpinnerGrid.__init__))
