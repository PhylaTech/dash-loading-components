...
class EpicSemipolarSpinner(Component):
    """An EpicSemipolarSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicSemipolarSpinner, self).__init__(**args)

setattr(EpicSemipolarSpinner, "__init__", _explicitize_args(EpicSemipolarSpinner.__init__))
