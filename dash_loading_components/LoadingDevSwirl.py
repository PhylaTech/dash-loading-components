...
class LoadingDevSwirl(Component):
    """A LoadingDevSwirl component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevSwirl, self).__init__(**args)

setattr(LoadingDevSwirl, "__init__", _explicitize_args(LoadingDevSwirl.__init__))
