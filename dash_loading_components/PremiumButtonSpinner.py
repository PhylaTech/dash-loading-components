...
class PremiumButtonSpinner(Component):
    """A PremiumButtonSpinner component.
...
- visible (boolean; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PremiumButtonSpinner, self).__init__(**args)

setattr(PremiumButtonSpinner, "__init__", _explicitize_args(PremiumButtonSpinner.__init__))
