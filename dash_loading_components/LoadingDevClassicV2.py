...
class LoadingDevClassicV2(Component):
    """A LoadingDevClassicV2 component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevClassicV2, self).__init__(**args)

setattr(LoadingDevClassicV2, "__init__", _explicitize_args(LoadingDevClassicV2.__init__))
