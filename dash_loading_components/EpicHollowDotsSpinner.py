...
class EpicHollowDotsSpinner(Component):
    """An EpicHollowDotsSpinner component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(EpicHollowDotsSpinner, self).__init__(**args)

setattr(EpicHollowDotsSpinner, "__init__", _explicitize_args(EpicHollowDotsSpinner.__init__))
