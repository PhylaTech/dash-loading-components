...
class LoadingDevFlip(Component):
    """A LoadingDevFlip component.
LoadingDevFlip — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevFlip, self).__init__(**args)

setattr(LoadingDevFlip, "__init__", _explicitize_args(LoadingDevFlip.__init__))
