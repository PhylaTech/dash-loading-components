...
class LoadingDevOrbit(Component):
    """A LoadingDevOrbit component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevOrbit, self).__init__(**args)

setattr(LoadingDevOrbit, "__init__", _explicitize_args(LoadingDevOrbit.__init__))
