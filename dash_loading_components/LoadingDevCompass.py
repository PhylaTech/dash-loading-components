...
class LoadingDevCompass(Component):
    """A LoadingDevCompass component.
LoadingDevCompass — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevCompass, self).__init__(**args)

setattr(LoadingDevCompass, "__init__", _explicitize_args(LoadingDevCompass.__init__))
