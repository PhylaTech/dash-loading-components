...
class LoaderSpinnerInfinitySpin(Component):
    """A LoaderSpinnerInfinitySpin component.
...
- width (number | string; optional):
    ...
    _type = 'LoaderSpinnerInfinitySpin'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoaderSpinnerInfinitySpin, self).__init__(**args)

setattr(LoaderSpinnerInfinitySpin, "__init__", _explicitize_args(LoaderSpinnerInfinitySpin.__init__))
