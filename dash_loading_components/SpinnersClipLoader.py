...
class SpinnersClipLoader(Component):
    """A SpinnersClipLoader component.
SpinnersClipLoader — Dash wrapper for upstream spinner.
...
- width (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SpinnersClipLoader, self).__init__(**args)

setattr(SpinnersClipLoader, "__init__", _explicitize_args(SpinnersClipLoader.__init__))
