...
class PremiumPulseWave(Component):
    """A PremiumPulseWave component.
...
- speed (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PremiumPulseWave, self).__init__(**args)

setattr(PremiumPulseWave, "__init__", _explicitize_args(PremiumPulseWave.__init__))
