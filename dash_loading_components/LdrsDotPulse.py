...
class LdrsDotPulse(Component):
    """A LdrsDotPulse component.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LdrsDotPulse, self).__init__(**args)

setattr(LdrsDotPulse, "__init__", _explicitize_args(LdrsDotPulse.__init__))
