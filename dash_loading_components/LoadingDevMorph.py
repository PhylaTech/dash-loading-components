...
class LoadingDevMorph(Component):
    """A LoadingDevMorph component.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevMorph, self).__init__(**args)

setattr(LoadingDevMorph, "__init__", _explicitize_args(LoadingDevMorph.__init__))
