...
class PremiumSpinnerDots(Component):
    """A PremiumSpinnerDots component.
...
- visible (boolean; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PremiumSpinnerDots, self).__init__(**args)

setattr(PremiumSpinnerDots, "__init__", _explicitize_args(PremiumSpinnerDots.__init__))
