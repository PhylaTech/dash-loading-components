...
class IndicatorsFourSquare(Component):
    """An IndicatorsFourSquare component.
IndicatorsFourSquare — Dash wrapper for upstream spinner.
...
- variant (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'easing', 'size', 'speedPlus', 'style', 'text', 'textColor', 'variant']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'easing', 'size', 'speedPlus', 'style', 'text', 'textColor', 'variant']
        ...
        super(IndicatorsFourSquare, self).__init__(**args)

setattr(IndicatorsFourSquare, "__init__", _explicitize_args(IndicatorsFourSquare.__init__))
