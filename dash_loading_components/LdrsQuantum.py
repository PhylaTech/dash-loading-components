...
class LdrsQuantum(Component):
    """A LdrsQuantum component.
LdrsQuantum — Dash wrapper for upstream spinner.
...
- stroke (number | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'className', 'color', 'playing', 'rate', 'size', 'speed', 'stroke', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'className', 'color', 'playing', 'rate', 'size', 'speed', 'stroke', 'style']
        ...
        super(LdrsQuantum, self).__init__(**args)

setattr(LdrsQuantum, "__init__", _explicitize_args(LdrsQuantum.__init__))
