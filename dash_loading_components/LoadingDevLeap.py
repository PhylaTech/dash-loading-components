...
class LoadingDevLeap(Component):
    """A LoadingDevLeap component.
LoadingDevLeap — Dash wrapper for upstream spinner.
...
- size (number; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LoadingDevLeap, self).__init__(**args)

setattr(LoadingDevLeap, "__init__", _explicitize_args(LoadingDevLeap.__init__))
